...
STANDARD_SETTINGS = {
    ...
    'PIP_REQUIREMENTS_PATH': 'PATH TO/{{ project_name }}/{{ project_name }}/reqs/', # relative (starts in repository)
...
# Host definitions.
@define_host('popcode@quiz.popcode.com.br')
def production():
    """Popcode beta server."""
